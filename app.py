...
st.title('Detection of Phishing Websites using Machine Learning')
st.write('This ML based app is developed for educational purposes. The purpose of the application is to detect phishing websites using only content data. No URLs!'
'You can see the details of the approach, dataset and feature set if you click "See the Details".')


with st.expander("PROJECT DESCRIPTION"):
    st.subheader('Approach')
    st.write('I used machine learning algorithms to classify phishing and legitimate websites. '
    ...
    st.write('For this project, '
             'I defined the data set and features from the kaggle.com. '
